...
/**
 ** \file include/cli/parsing/parser.h
 ** Define the parser::parser class.
 */

// C++ LALR(1) parser skeleton written by Akim Demaille.

#ifndef YY_YY_INCLUDE_CLI_PARSING_PARSER_H_INCLUDED
# define YY_YY_INCLUDE_CLI_PARSING_PARSER_H_INCLUDED
...
#line 57 "include/cli/parsing/parser.h" // lalr1.cc:372
...
# include <cli/parsing/location.h>
...
namespace parser {
#line 133 "include/cli/parsing/parser.h" // lalr1.cc:372
  ...
  basic_symbol (typename Base::kind_type t, const uint v, const location_type& l);
    ...
    static inline
    symbol_type
    make_ESCAPED_LITERAL (const std::string& v, const location_type& l);

    static inline
    symbol_type
    make_LIT (const std::string& v, const location_type& l);
    ...
    static inline
    symbol_type
    make_RE_LEFT (const location_type& l);

    static inline
    symbol_type
    make_RE_RIGHT (const location_type& l);
    ...
    static inline
    symbol_type
    make_ALTERNATION (const location_type& l);

    static inline
    symbol_type
    make_KLEENE (const location_type& l);
    ...
    Parser (class k2tdb::cli::Driver& driver_yyarg);
    virtual ~Parser ();
  ...
  private:
    ...
    // User arguments.
    class k2tdb::cli::Driver& driver;
  };


#line 28 "parsing/parser.yy" // lalr1.cc:372
} // parser
#line 737 "include/cli/parsing/parser.h" // lalr1.cc:372




#endif // !YY_YY_INCLUDE_CLI_PARSING_PARSER_H_INCLUDED
